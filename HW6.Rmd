...
The data were retrieved from a word document in the supplemental information and transferred into a `.csv` document. Read in the dataset. 

```{r}
# this dataset should be in the same directory as your HW6 R Project
sealions <- read_csv("Sealions.csv", na = '-')
```
